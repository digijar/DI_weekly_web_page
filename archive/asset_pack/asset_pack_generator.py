...
import uvicorn
import ast
from retrieve_bigquery_service import retrieve_bigquery
...
# def main(row_num):
    ...
    req_obj = retrieve_bigquery(row_num).body.decode()
    info = ast.literal_eval(req_obj)
    print(info)
    # info = json.loads(req_obj)
    ...
    content = {
        ...
        "biz_desc": [],
        "biz_summary": info["col_summary"]["Business_Description"],
        "deal_overview":info["col_summary"]["Deal_Intelligence_info"],
        "sit_overview":[],
        "deal_stage":[],
        "deal_rationale":[],
        ...
        "found_year":1900,
        "dominant_country": info["dominant_country"],
    ...
    template_path = "../../../results/input/templates/AssetPackSample_v0.53.pptx"
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run("asset_pack_generator:app", host='127.0.0.1', port=5010, reload=True)