...
# # # slide 12
def gen_s11(presentation,content,bulleted_category_s12):
    """
    This function replaces all placeholder text in form of {information key} with respective
    values under the identical key in content dict.
...
# def main(row_num):
    ...
    try:
        ...
        presentation = gen_s11(presentation,content,bulleted_category_s12)
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run("asset_pack_generator_v7:app", host='127.0.0.1', port=5010, reload=True)